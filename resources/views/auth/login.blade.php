...
@section('content')
<section class="login-sec login-custom">
    <div class="container">
            ...
            <div class="row login-main-fture justify-content-center">
                <div class="col-auto mb-4 mb-md-0">
                    <div class="login-feature">
                        <img src="{{ asset('images/find-we-do-icon2.png')}}">
        ...
        <div class="sign-up-social">
            <ul>
              <li class="login-facebook">
                <a href="{{ url('/login/facebook') }}"><i class="fa fa-facebook" aria-hidden="true"></i> Sign in with Facebook</a>
              </li>
              <li class="login-google">
                <a href="{{ url('/login/google') }}"><img src="images/google.png"> Sign in with Google</a>
              </li>
            </ul>
      </div>
